    ...
    _createClass(ProductVariants, [{
      ...
      value: function _updateProductPrices(newVariant, previousVariant) {
        ...
        if (newVariant['compare_at_price'] > newVariant['price']) {
            ...
            productPrices.innerHTML += "<div class=\"discount__percentage\">".concat(Math.round(100 - ((newVariant['price']) * 100) / (newVariant['compare_at_price'])), "% OFF</div>");
            
            productPrices.innerHTML += "<br>";
            productPrices.innerHTML += "<p style=\"color: var(--text-color); margin: 3px 0px 0px 0px;\"> ou em até <b style=\"color: var(--product-on-sale-accent); font-size: 17px\">12x</b> de <b style=\"color: var(--product-on-sale-accent); font-size: 20px\">".concat(Currency.formatMoney(newVariant['price'] / 12 * 1.1979 , window.theme.moneyFormat), "</b></p>");
            productPrices.innerHTML += "<div class=\"product-meta__label-list\"><span style=\"margin-top: 10px; font-size: 15px\" class=\"product-label product-label--on-sale\">ECONOMIA DE <span class=\"economia\">".concat(Currency.formatMoney((newVariant['compare_at_price']) - (newVariant['price']), window.theme.moneyFormat),"</span></span></div>");
        } else {
            productPrices.innerHTML += "<span style=\"color: var(--product-on-sale-accent); font-weight: 700;\" class=\"price\" data-money-convertible>".concat(Currency.formatMoney(newVariant['price'], window.theme.moneyFormat), "</span>");
            productPrices.innerHTML += "<p style=\"color: var(--text-color); margin: 3px 0px 0px 0px;\"> ou em até <b style=\"color: var(--product-on-sale-accent); font-size: 17px\">12x</b> de <b style=\"color: var(--product-on-sale-accent); font-size: 20px\">".concat(Currency.formatMoney(newVariant['price'] / 12 * 1.1979 , window.theme.moneyFormat), "</b></p>");
        }
      ...
      value: function _updateAddToCartButton(newVariant) {
        ...
        if (!newVariant) {
          ...
          if (newVariant['available']) {
            ...
            addToCartButtonElement.innerHTML = "<i class=\"fas fa-shopping-basket\" style=\"margin-right: 0.3em\"></i>".concat(window.languages.productFormAddToCart);
          } else {
            addToCartButtonElement.setAttribute('disabled', 'disabled');
            addToCartButtonElement.classList.add('button--disabled');
            addToCartButtonElement.classList.remove('button--primary');
            addToCartButtonElement.removeAttribute('data-action');
            addToCartButtonElement.innerHTML = "<i class=\"fas fa-shopping-basket\" style=\"margin-right: 0.3em\"></i>".concat(window.languages.productFormSoldOut);
          }
